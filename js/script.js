/* ==========================================================================
   RF SOLUÇÕES - INTERATIVIDADE PREMIUM (ES6)
...
function initServiceModals() {
    ...
    const mImage = document.getElementById('modal-service-image');
    ...
    function closeModal() {
        ...
        // Remove listener de teclado (Corrigido para removeEventListener)
